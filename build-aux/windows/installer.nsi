...
; installer.nsi, renamed for Intv.
;
...
!endif
!ifndef SRCDIR
  !define SRCDIR "dist\FujiNet-Go-Intv"
!endif
!ifndef OUTFILE
  !define OUTFILE "FujiNet-Go-Intv-Setup.exe"
!endif
...
!define APPNAME    "FujiNet Go Intv"
!define PUBLISHER  "Thomas Cherryhomes"
!define EXENAME    "fujinet-go-intv-windows.exe"
!define HOMEPAGE   "https://fujinet.online/"
!define REGAPP     "Software\FujiNetGoIntv"
!define REGUNINST  "Software\Microsoft\Windows\CurrentVersion\Uninstall\FujiNetGoIntv"
...
Section "Uninstall"
  ...
  ; Settings, ROM directory and the provisioned FujiNet tree live under
  ; %LOCALAPPDATA%\fujinet-go-intv and are deliberately left behind: an
  ; uninstall should not throw away someone's configuration or imported
  ; ROMs, and a reinstall picks it straight back up.
SectionEnd
